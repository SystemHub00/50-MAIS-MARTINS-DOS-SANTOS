...
# =============================================================================
LOCAL_OPTIONS = [
    {"id": "1", "nome": "VILA ROSALI — SÃO JOÃO DE MERITI"},
]
...
# =============================================================================
SCHEDULE_OPTIONS = {
    "1": {"dias_aula": "Sábado", "horario": "09h às 11h"},
}

# =============================================================================
# 4-5. DATAS
# =============================================================================
START_DATE_OPTIONS = {"1": "15/08/2026"}
END_DATE_OPTIONS   = {"1": "05/09/2026"}

# =============================================================================
# 6. ENDERE\u00c7OS
# =============================================================================
ADDRESS_OPTIONS = {
    "1": "📍Av. Heronildes Martins dos Santos, 1520 – Vila Rosali – São João de Meriti – RJ – CEP 25510-011",
}
...
TURMA_OPTIONS = [
    {"id": "1", "curso_id": "1", "local_id": "1",
     "turma_codigo": "CUI-SJM-01",
     "turma_label": "CUIDADOR DE IDOSOS — Sábado 9h–11h",
     "agenda_id": "1", "periodo_id": "1", "encerramento_id": "1", "endereco_id": "1"},
    {"id": "2", "curso_id": "2", "local_id": "1",
     "turma_codigo": "ADM-SJM-01",
     "turma_label": "ASSISTENTE ADMINISTRATIVO — Sábado 9h–11h",
     "agenda_id": "1", "periodo_id": "1", "encerramento_id": "1", "endereco_id": "1"},
    {"id": "3", "curso_id": "3", "local_id": "1",
     "turma_codigo": "SER-SJM-01",
     "turma_label": "SERVIÇOS GERAIS — Sábado 9h–11h",
     "agenda_id": "1", "periodo_id": "1", "encerramento_id": "1", "endereco_id": "1"},
    {"id": "4", "curso_id": "4", "local_id": "1",
     "turma_codigo": "POR-SJM-01",
     "turma_label": "PORTEIRO E RECEPÇÃO — Sábado 9h–11h",
     "agenda_id": "1", "periodo_id": "1", "encerramento_id": "1", "endereco_id": "1"},
]
...
<body data-start-step="{{ current_step }}">
            ...
            <form id="wizard-form" method="POST" action="{{ url_for('inscricao_unica') }}" autocomplete="off" novalidate>
                ...
                <section class="wizard-panel" data-step="index">
                    <div class="hero-grid"><div class="hero-card">
                        <span class="hero-pill">EMPREGA 50+ RJ</span>
                            ...
                            <div class="hero-highlight">
                                ...
                                <div class="benefits-slider" data-benefits-slider>
                                    <div class="benefits-viewport">
                                            ...
                                            <div class="benefit-slide">Qualificação para quem deseja crescer</div>
                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            benefitsSliders.forEach(initBenefitsSlider);syncReview();mostrarPasso(stepOrder.includes(startStep)?startStep:'index');
        });
    </script>
</body>
</html>
